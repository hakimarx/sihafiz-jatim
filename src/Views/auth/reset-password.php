        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5 col-xl-4">
                ...
                <div class="text-center mb-4 login-header">
                    ...
                    <p class="text-white-50 opacity-75">Pengaturan Ulang Kata Sandi</p>
                </div>
                ...
                <div class="card login-card border-0 shadow-lg overflow-hidden">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <h4 class="fw-bold text-dark mb-3 text-center">Atur Password Baru</h4>
                        <p class="text-muted text-center small mb-4">Silakan tentukan password baru Anda yang kuat dan mudah diingat.</p>
                        ...
                        <!-- Form -->
                        <form action="<?= APP_URL ?>/reset-password" method="POST" class="login-form">
                            <?= csrfField() ?>
                            <input type="hidden" name="token" value="<?= htmlspecialchars($token) ?>">

                            <div class="mb-4">
                                <label for="password" class="form-label small fw-bold text-secondary text-uppercase">Password Baru</label>
                                <div class="input-group login-input-group">
                                    ...
                                    <input type="password" class="form-control border-start-0 ps-0" id="password" name="password"
                                        placeholder="Min. 6 Karakter" required autofocus>
                                </div>
                            </div>

                            <div class="mb-4">
                                <label for="confirm_password" class="form-label small fw-bold text-secondary text-uppercase">Konfirmasi Password</label>
                                <div class="input-group login-input-group">
                                    <span class="input-group-text bg-transparent border-end-0">
                            ...
                            <button type="submit" class="btn btn-success btn-lg w-100 py-3 fw-bold login-btn mb-4">
                                SIMPAN PASSWORD <i class="bi bi-check-circle ms-2"></i>
                            </button>
                        </form>
                    </div>
                </div>
