...
<div class="row">
    ...
    <div class="col-lg-8">
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-white">
                <h6 class="mb-0 fw-bold"><i class="bi bi-card-list me-2"></i>Data Pribadi</h6>
            </div>
            <div class="card-body">
                <table class="table table-borderless align-middle">
                    ...
                    <tr>
                        ...
                        <td><?= htmlspecialchars($hafiz['tempat_lahir'] ?? '-') ?>, <?= !empty($hafiz['tanggal_lahir']) ? date('d F Y', strtotime($hafiz['tanggal_lahir'])) : '-' ?></td>
                    </tr>
                    <tr>
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-white">
                <h6 class="mb-0 fw-bold"><i class="bi bi-book me-2"></i>Data Hafalan & Mengajar</h6>
            </div>
            <div class="card-body">
                <table class="table table-borderless align-middle">
                    <tr>
                        <td width="200" class="text-muted">Lembaga Sertifikat</td>
                        <td><?= htmlspecialchars($hafiz['sertifikat_tahfidz'] ?? '-') ?></td>
                    </tr>
                    <tr>
                        <td class="text-muted">Status Mengajar</td>
                        <td>
                            <span class="badge bg-<?= $hafiz['mengajar'] ? 'success' : 'secondary' ?>">
                                <?= $hafiz['mengajar'] ? 'Ya' : 'Tidak' ?>
                            </span>
                        </td>
                    </tr>
                        ...
                        <?php foreach ($mengajarList as $item): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br><small class="text-muted">(TMT: <?= date('d F Y', strtotime($item['tmt_mengajar'])) ?>)</small>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-<?= $hafiz['status_insentif'] === 'aktif' ? 'success' : 'secondary' ?>">
                                <?= ucfirst(str_replace('_', ' ', $hafiz['status_insentif'] ?? 'non_aktif')) ?>
                            </span>
                        </td>
                    </tr>
                </table>
        ...
        <?php if (!empty($hafiz['nama_bank']) || !empty($hafiz['nomor_rekening'])): ?>
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white">
                    <h6 class="mb-0 fw-bold"><i class="bi bi-bank me-2"></i>Data Bank</h6>
                </div>
                <div class="card-body">
